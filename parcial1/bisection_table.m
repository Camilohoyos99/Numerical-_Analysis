function bisection_table(f, a, b, tol, max_iter)
...
if error <= tol
    disp(['El método de bisección convergió en ', num2str(n), ' iteraciones.'])
else
    disp('El método de bisección no convergió en el número máximo de iteraciones.')
end
